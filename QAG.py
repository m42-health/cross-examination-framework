...
async def generate_qa_from_text(text: str, llm_opts: dict, num_questions: int = 5, 
    ...
    if not isinstance(llm_output, str):
        ...
        print(f"This is an instance of llm_output NOT being a string {type(llm_output).__name__}!")  # TODO: what causes llm_output to be None?
        return None
    else:
...
def calculate_scores(samp, key1, key2) -> dict:
    ...
    if questions_on_summaries is not None:
        ...
        for question in questions_on_summaries:
            if question["predicted"] != "IDK" and question["predicted"] != question["gold"]:
                conform -= 1
            elif question["gold"] == "IDK":
                conform -= 1
                total -= 1
