...
judge_index = 1  # Change this - the model that generated the questions
...
ds_path = f"/data/cef/boxscore/boxscore_questions_{judge_model.replace('/', '+++')}"
...
# 1. Questions from src (boxscore), answered using src (should be YES)
# 2. Questions from src (boxscore), answered using trg (game summary)
# 3. Questions from trg (game summary), answered using trg (should be YES)
# 4. Questions from trg (game summary), answered using src (boxscore)
...
for idx, model in enumerate(judge_models):
    ...
    answer_generator = BoxscoreAnswerGenerator(
...
# %%
output_path = f"/data/cef/boxscore/boxscore_answers_{judge_model.replace('/', '+++')}"
