...
#     Resource Request       #
##############################
#SBATCH --job-name=eval_di_trad_all
#SBATCH --nodes=1
...
RESULTS_PATH="/data/cef/dischargeme/results_di_traditional"

cd /home/yathagata/cef-translation/src/evaluation

echo "========================================="
echo "Starting DI Traditional metrics evaluation for all models"
...
for MODEL_NAME in "${MODELS[@]}"; do
    echo "========================================="
    echo "DI Traditional Metrics: ${MODEL_NAME}"
    echo "Time: $(date)"
    echo "========================================="
