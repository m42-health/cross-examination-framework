#!/usr/bin/env python3
"""
vLLM Translation Script for Europarl Dataset (Hugging Face Format)
...
class TranslationPipeline:
    def __init__(self):
        self.models = {
            "qwen2.5-7b":"/models_llm/Qwen2.5-7B-Instruct",
            #"mistral7b": "/models_llm/Mistral-7B-Instruct-v0.3",
        ...
        self.data_path = "/data/cef/europarl/filtered_1381"
    ...
    def process_model(self, model_key: str, source_dataset: Dataset, batch_size: int = 32):
        ...
        base_path = os.path.join(self.data_path, f"europarl_{model_key}_all_languages")
